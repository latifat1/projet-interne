...
//   return (
//     <div className="relative h-[750px] overflow-hidden" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
...
export function TeamHeroSlider() {
  ...
  return (
    <div className="relative h-[650px] md:h-[750px] overflow-hidden" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      {slides.map((slide, index) => (
        <div
          key={slide.id}
          className={cn(
